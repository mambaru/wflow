 ...
 * @brief Пример того, как можно забить очередь чтобы таймеры не сработали вовремя
 * @details В конфигурации 4 потока отправляем 4 задания которые засыпают и неотпускают 
